...
<main class="landing-page">
  ...
  <section class="hero" id="top" aria-labelledby="landing-title">
    <div class="hero-copy">
      ...
      <h1 id="landing-title">Build confidence,<br /><em>one touch at a time.</em></h1>
      <p class="hero-intro">A calm, encouraging activity that helps learners practice finding and choosing pictures on a screen.</p>
